...
export const categories = [
  { name: "Nouveau", icon: <AiFillHome />, type: "home" },
  { name: "Tendances", icon: <MdLocalFireDepartment />, type: "category" },
  { name: "Musique", icon: <CgMusicNote />, type: "category" },
  { name: "Films et TV", icon: <FiFilm />, type: "category" },
  { name: "Direct", icon: <MdLiveTv />, type: "category" },
  { name: "Jeux vidéo", icon: <IoGameControllerSharp />, type: "category" },
  { name: "Actualités", icon: <ImNewspaper />, type: "category" },
  { name: "Sports", icon: <GiDiamondTrophy />, type: "category" },
  { name: "Savoirs & Cultures", icon: <RiLightbulbLine />, type: "category" },
  {
    name: "Mode et beauté",
    icon: <GiEclipse />,
    type: "category",
  ...
  {
    name: "Historique des signalements",
    icon: <AiOutlineFlag />,
    type: "menu",
  },
